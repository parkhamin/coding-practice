...
**260106**
1. 4344
- String format 방법: System.out.printf("%.3f%n", rate)
- 소수점 3글자까지 출력후 줄 바꿈
2. 2869
- 아이디어 자체는 맞았지만 while(true) 사용할 경우 시간 초과 위험!
- 수학 공식을 도출하는 연습을 하자
- 올림 나눗셈 공식 x / y -> (x + y) - 1 / y
3. 10989
- 출력량 적을 경우 : println
- 문자열 가공할 경우 : StringBuilder
- 출력량이 많을 경우 : BufferedWriter
- 대용량 + 코테 : BufferedWriter 사용!!